...
public class DlnaTerChListItem {
    ...
    public boolean equalTo(final DlnaTerChListItem item2) {
        return !(null == item2 || null == this.mChannelName || null == item2.mChannelName || null == this.mResUrl
                || null == item2.mResUrl) && this.mChannelName.equals(item2.mChannelName) && this.mResUrl.equals(item2.mResUrl);
    }
}
