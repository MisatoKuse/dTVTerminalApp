...
namespace dtvt {
    ...
    void DlnaBSDigitalXmlParser::parse(void *fileStr, vector<VectorString>& out){
                ...
                if(xmlChildNode->xmlChildrenNode != NULL)
                {
                    ...
                    if (!xmlStrcmp(xmlChildNode->name, (const xmlChar*)BsXmlParser_Field_Class))
                    {
                        if(!xmlStrcmp(xmlNodeGetContent(xmlChildNode), (const xmlChar*)BsXmlParser_Field_VideoItem) && isVideo){
                            v1.push_back(BsXmlParser_Field_Mp4_Ret);
                            out.push_back(v1);
                        }
                        isVideo = false;
                    }
...
//                if(xmlChildNode->xmlChildrenNode != NULL)
//                {
//                    if (0==xmlStrcmp(xmlChildNode->name, (const xmlChar*)BsXmlParser_Field_Item))
//                    {
//                        itemXmlItemMap.clear();
//                        isItVideo=false;
//
//                        char* tmpP= (char*)xmlGetProp(xmlChildNode, (const xmlChar*)BsXmlParser_Field_Id);
//                        if(NULL!=tmpP){
...
//                        while(NULL!=child) {
//                            if (0 == xmlStrcmp(child->name, (const xmlChar *) BsXmlParser_Field_Title)) {
...
//                            }
//                            if (0 == xmlStrcmp(child->name, (const xmlChar *) BsXmlParser_Field_Res)) {
//                                char* tmpP= (char *) xmlGetProp(child, (const xmlChar *) BsXmlParser_Field_ProtocolInfo);
//                                if(NULL==tmpP){
//                                    return;
//                                }
//                                std::string protocolInfo(tmpP);
//                                if (protocolInfo.find(BsXmlParser_Field_Mp4) != string::npos ||
//                                    string::npos != protocolInfo.find(BsXmlParser_Field_Dtcp)) {
//
//                                    if(protocolInfo.find(BsXmlParser_Field_Mp4) != string::npos){
//                                        itemXmlItemMap[Xml_Item_VideoType] = BsXmlParser_Field_Mp4_Ret;
//                                    }
//                                    if(protocolInfo.find(BsXmlParser_Field_Dtcp) != string::npos){
//                                        itemXmlItemMap[Xml_Item_VideoType] = protocolInfo;
//                                    }
//
//                                    char *tmpP = (char *) xmlGetProp(child, (const xmlChar *) BsXmlParser_Field_Size);
//                                    if (NULL == tmpP) {
...
//                                    }
//
//                                    tmpP = (char *) xmlGetProp(child, (const xmlChar *) BsXmlParser_Field_Duration);
//                                    if (NULL == tmpP) {
...
//                                    }
//
//                                    tmpP = (char *) xmlGetProp(child, (const xmlChar *) BsXmlParser_Field_Resolution);
//                                    if (NULL == tmpP) {
...
//                                    }
//
//                                    tmpP = (char *) xmlGetProp(child, (const xmlChar *) BsXmlParser_Field_Bitrate);
//                                    if (NULL == tmpP) {
...
//                                }
//                            }
//                            if (0 == xmlStrcmp(child->name, (const xmlChar *) BsXmlParser_Field_AlbumArtURI)) {
//                                if (0==xmlStrcmp((const xmlChar *) xmlGetProp(child, (const xmlChar *) BsXmlParser_Field_ProfileID),
//                                               (const xmlChar *) BsXmlParser_Field_PNG_LRG)) {
//                                    char* tmpP= (char *) xmlNodeGetContent(child);
//                                    if(NULL!=tmpP){
...
//                                }
//                            }
//                            if (0 == xmlStrcmp(child->name, (const xmlChar *) BsXmlParser_Field_Date)) {
//                                char* tmpP= (char *) xmlNodeGetContent(child);
//                                if(NULL!=tmpP){
...
//                                }
//                            }
//                            if (0== xmlStrcmp(child->name, (const xmlChar *) BsXmlParser_Field_Class)) {
//                                if (NULL != xmlStrstr(xmlNodeGetContent(child), (const xmlChar *) BsXmlParser_Field_VideoItem)) {
//                                    isItVideo = true;
//                                } else {
//                                    isItVideo = false;
//                                }
...
//        }
                            ...
                            while(NULL!=child && !error) {
                                ...
                                if (0 == xmlStrcmp(child->name, (const xmlChar *) BsXmlParser_Field_Res)) {
                                    ...
                                    if (protocolInfo.find(BsXmlParser_Field_Mp4) != string::npos ||
                                        ...
                                        if(protocolInfo.find(BsXmlParser_Field_Mp4) != string::npos){
                                            itemXmlItemMap[Xml_Item_VideoType] = BsXmlParser_Field_Mp4_Ret;
                                        }else if(protocolInfo.find(BsXmlParser_Field_Dtcp) != string::npos){
                                            itemXmlItemMap[Xml_Item_VideoType] = protocolInfo;
                                        } else {
        ...
        //                        }
                                ...
                                if (0== xmlStrcmp(child->name, (const xmlChar *) BsXmlParser_Field_ChannelName)) {
                                    char* tmpP= (char *) xmlNodeGetContent(child);
                                    if(NULL!=tmpP){
