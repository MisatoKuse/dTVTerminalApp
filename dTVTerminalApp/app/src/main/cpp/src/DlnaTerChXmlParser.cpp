...
namespace dtvt {
    ...
    DlnaTerChXmlParser::DlnaTerChXmlParser(): DlnaXmlParserBase(DLNA_MSG_ID_TER_CHANNEL_LIST){

    }
    void DlnaTerChXmlParser::parse(void *fileStr, vector<VectorString>& out){}

    static bool isVideo = false;

#if defined(DLNA_KARI_DMS_UNIVERSAL)
    void DlnaTerChXmlParser::parseXmlNode(const xmlNodePtr & xmlRootNode, vector<VectorString>& out, VectorString& v1, std::string &containerId, std::string &isContainerId)
        {
                ...
                if(xmlChildNode->xmlChildrenNode != NULL)
                {
                    ...
                    if (!xmlStrcmp(xmlChildNode->name, (const xmlChar*)TerChXmlParser_Field_Class))
                    {
                        if(!xmlStrcmp(xmlNodeGetContent(xmlChildNode), (const xmlChar*)TerChXmlParser_Field_VideoItem) && isVideo){
                            v1.push_back(TerChXmlParser_Field_Mp4_Ret);
                            out.push_back(v1);
                        }
                        isVideo = false;
                    }
...
//                if(xmlChildNode->xmlChildrenNode != NULL)
//                {
//                    if (0==xmlStrcmp(xmlChildNode->name, (const xmlChar*)TerChXmlParser_Field_Item))
//                    {
//                        itemXmlItemMap.clear();
//                        isItVideo=false;
//
//                        char* tmpP= (char*)xmlGetProp(xmlChildNode, (const xmlChar*)TerChXmlParser_Field_Id);
//                        if(NULL!=tmpP){
...
//                        while(NULL!=child) {
//                            if (0 == xmlStrcmp(child->name, (const xmlChar *) TerChXmlParser_Field_Title)) {
...
//                            }
//                            if (0 == xmlStrcmp(child->name, (const xmlChar *) TerChXmlParser_Field_Res)) {
//                                char* tmpP= (char *) xmlGetProp(child, (const xmlChar *) TerChXmlParser_Field_ProtocolInfo);
//                                if(NULL==tmpP){
//                                    return;
//                                }
//                                std::string protocolInfo(tmpP);
//                                if (protocolInfo.find(TerChXmlParser_Field_Mp4) != string::npos ||
//                                    string::npos != protocolInfo.find(TerChXmlParser_Field_Dtcp)) {
//
//                                    if(protocolInfo.find(TerChXmlParser_Field_Mp4) != string::npos){
//                                        itemXmlItemMap[Xml_Item_VideoType] = TerChXmlParser_Field_Mp4_Ret;
//                                    }
//                                    if(protocolInfo.find(TerChXmlParser_Field_Dtcp) != string::npos){
//                                        itemXmlItemMap[Xml_Item_VideoType] = protocolInfo;
//                                    }
//
//                                    char *tmpP = (char *) xmlGetProp(child, (const xmlChar *) TerChXmlParser_Field_Size);
//                                    if (NULL == tmpP) {
...
//                                    }
//
//                                    tmpP = (char *) xmlGetProp(child, (const xmlChar *) TerChXmlParser_Field_Duration);
//                                    if (NULL == tmpP) {
...
//                                    }
//
//                                    tmpP = (char *) xmlGetProp(child, (const xmlChar *) TerChXmlParser_Field_Resolution);
//                                    if (NULL == tmpP) {
...
//                                    }
//
//                                    tmpP = (char *) xmlGetProp(child, (const xmlChar *) TerChXmlParser_Field_Bitrate);
//                                    if (NULL == tmpP) {
...
//                                }
//                            }
//                            if (0 == xmlStrcmp(child->name, (const xmlChar *) TerChXmlParser_Field_AlbumArtURI)) {
//                                if (0==xmlStrcmp((const xmlChar *) xmlGetProp(child, (const xmlChar *) TerChXmlParser_Field_ProfileID),
//                                               (const xmlChar *) TerChXmlParser_Field_PNG_LRG)) {
//                                    char* tmpP= (char *) xmlNodeGetContent(child);
//                                    if(NULL!=tmpP){
...
//                                }
//                            }
//                            if (0 == xmlStrcmp(child->name, (const xmlChar *) TerChXmlParser_Field_Date)) {
//                                char* tmpP= (char *) xmlNodeGetContent(child);
//                                if(NULL!=tmpP){
...
//                                }
//                            }
//                            if (0== xmlStrcmp(child->name, (const xmlChar *) TerChXmlParser_Field_Class)) {
//                                if (NULL != xmlStrstr(xmlNodeGetContent(child), (const xmlChar *) TerChXmlParser_Field_VideoItem)) {
//                                    isItVideo = true;
//                                } else {
//                                    isItVideo = false;
//                                }
                            ...
                            while(NULL!=child && !error) {
                                ...
                                if (0 == xmlStrcmp(child->name, (const xmlChar *) TerChXmlParser_Field_Res)) {
                                    ...
                                    if (protocolInfo.find(TerChXmlParser_Field_Mp4) != string::npos ||
                                        ...
                                        if(protocolInfo.find(TerChXmlParser_Field_Mp4) != string::npos){
                                            itemXmlItemMap[Xml_Item_VideoType] = TerChXmlParser_Field_Mp4_Ret;
                                        }else if(protocolInfo.find(TerChXmlParser_Field_Dtcp) != string::npos){
                                            itemXmlItemMap[Xml_Item_VideoType] = protocolInfo;
                                        } else {
