...
/**
 * @file
 *   The du_csv interface provides methods for array of csv(Comma Separated Values)
...
/**
 *  Splits the csv string into substrings in a du_str_array array value_array.
 *  @param[in] csv the csv format string.
 ...
 *  yielding a single concatenated csv format string csv.
 *  @param[in] value_array pointer to the value array of substrings.
 *  @param[out] csv the concatenated csv format string.
 *  @return  true if the function succeeds.
 *           false if the  function fails.
...
/**
 *  Removes the last substring in the csv format string csv.
