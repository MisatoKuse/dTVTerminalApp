...
CHARDET_IMEXPORT int chardet_set_language_filter(chardet_t det, int language_filter);

CHARDET_IMEXPORT int chardet_change_confidence_coefficient(chardet_t det, const char* code, float coefficient);
