 ...
 *          false if the function fails.
 */
typedef const du_uchar* (*dupnp_dvc_service_component_get_component_name)();
 ...
 */
typedef dupnp_dvc_service_query_interface (*dupnp_dvc_service_component_get_query_interface)();
