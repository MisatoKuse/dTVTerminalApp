...
extern du_bool dupnp_ssdp_packetmgr_init(dupnp_ssdp_packetmgr* x, const du_ip* ip, du_uint32 interval_ms);

extern void dupnp_ssdp_packetmgr_free(dupnp_ssdp_packetmgr* x);

extern du_bool dupnp_ssdp_packetmgr_add(dupnp_ssdp_packetmgr* x, du_socket s, const du_uchar* data);
