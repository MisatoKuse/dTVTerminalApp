...
typedef struct dupnp_ssdp {
    ...
    du_socket search_socket6;
    du_id32 search_socket_task_id;
    du_id32 search_socket_task_id6;
    ...
    du_socket_array ssdp_socket_array6;
    du_uint32_array ssdp_socket_task_id_array;
    du_uint32_array ssdp_socket_task_id_array6;
    du_ip_array ssdp_socket_ip_array;
    du_ip_array ssdp_socket_ip_array6;
...
typedef struct dupnp_netif_monitor {
    ...
    du_mutex mutex;
    dupnp_netif_change_detector* detector;
} dupnp_netif_monitor;
...
struct dupnp_impl {
    ...
    dupnp_ip_version_flag ip_version_flag;
};
