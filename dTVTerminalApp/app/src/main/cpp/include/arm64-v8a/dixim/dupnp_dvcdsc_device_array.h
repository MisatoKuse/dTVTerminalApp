...
/** @file dupnp_dvcdsc_device_array.h
 *  @brief The dupnp_dvcdsc_device_array interface provides various methods for
 *   manipulating arrays of dupnp_dvcdsc_device structures ( such as allocation,
 *   initialization, searching, concatenation ).
 *   Before using a dupnp_dvcdsc_device_array, use <b>dupnp_dvcdsc_device_array_init</b> to
 *   initialize dupnp_dvcdsc_device_array.
 *   The dupnp_dvcdsc_device_array supports arrays that can dynamically grow as necessary.
 *   Array indexes always start at position 0.
 *   Deleting the allocated memory of dupnp_dvcdsc_device_array,
 *   use <b>dupnp_dvcdsc_device_array_free</b>.
 *  @see dupnp_dvcdsc.h, dupnp_dvc.h
 */

#ifndef DUPNP_DVCDSC_DEVICE_ARRAY_H
#define DUPNP_DVCDSC_DEVICE_ARRAY_H
...
/**
 * Resizable array which can contains dupnp_dvcdsc_device values.
 * @see dupnp_dvcdsc.h, dupnp_dvc.h
 */
typedef du_array dupnp_dvcdsc_device_array;

/**
 * Initializes an array.
 * @param[out] x   pointer to the array.
 */
#define dupnp_dvcdsc_device_array_init(x) du_array_init((x), sizeof(dupnp_dvcdsc_device))
 ...
 */
#define dupnp_dvcdsc_device_array_allocate(x, len) du_array_allocate((x), (len))
 ...
 *   0 if x has failed, or not enough memory is available.
 */
#define dupnp_dvcdsc_device_array_allocate_align(x, len) du_array_allocate_align((x), (len))
 ...
 */
#define dupnp_dvcdsc_device_array_get(x) ((dupnp_dvcdsc_device*)du_array_get(x))
 ...
 */
#define dupnp_dvcdsc_device_array_get_pos(x, pos) du_array_get_pos((x), (pos))
 ...
 */
extern du_uint32 dupnp_dvcdsc_device_array_find_udn(const dupnp_dvcdsc_device_array* x, const du_uchar* udn);
 ...
 */
#define dupnp_dvcdsc_device_array_length(x) du_array_length(x)
 ...
 * @return  the number of elements.
 */
#define dupnp_dvcdsc_device_array_bytes(x) du_array_bytes(x)
 ...
 */
#define dupnp_dvcdsc_device_array_truncate_length(x, len) du_array_truncate_length((x), (len))
 ...
 *          false if the number of elements is not changed.
 */
extern du_bool dupnp_dvcdsc_device_array_truncate_length_object(dupnp_dvcdsc_device_array* x, du_uint32 len);
 ...
 * @return  true.
 */
#define dupnp_dvcdsc_device_array_truncate(x) du_array_truncate(x)
 ...
 * @return  true.
 */
extern du_bool dupnp_dvcdsc_device_array_truncate_object(dupnp_dvcdsc_device_array* x);

/**
 * Frees the region used by <em>x</em>l
 * @param[in] x pointer to the array.
 */
#define dupnp_dvcdsc_device_array_free(x) du_array_free(x)

/**
 * Frees the region used by <em>x</em> and frees the all element objects.
 * @param[in] x pointer to the array.
 */
extern void dupnp_dvcdsc_device_array_free_object(dupnp_dvcdsc_device_array* x);
 ...
 */
#define dupnp_dvcdsc_device_array_failed(x) du_array_failed(x)
 ...
 */
#define dupnp_dvcdsc_device_array_equal(x, y) du_array_equal((x), (y))
 ...
 */
#define dupnp_dvcdsc_device_array_cat(to, from) du_array_cat((to), (from))
 ...
 */
#define dupnp_dvcdsc_device_array_catn(to, from, len) du_array_catn((to), (du_uint8*)(from), (len))
 ...
 */
#define dupnp_dvcdsc_device_array_cato(to, object_ptr) du_array_cato((to), (du_uint8*)(object_ptr))
 ...
 */
#define dupnp_dvcdsc_device_array_remove(x, pos) du_array_remove((x), (pos))
 ...
 */
extern du_bool dupnp_dvcdsc_device_array_remove_object(dupnp_dvcdsc_device_array* x, du_uint32 pos);
