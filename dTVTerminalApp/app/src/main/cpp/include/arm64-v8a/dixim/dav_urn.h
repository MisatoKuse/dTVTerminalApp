 ...
 * Returns a URN string of the XML namespace name required for the
 * JLabs() metadata.
 * This value is "urn:schemas-jlabs-or-jp:metadata-1-0".
 * @return  "urn:schemas-jlabs-or-jp:metadata-1-0" string.
 */
extern const du_uchar* dav_urn_jlabs_metadata1(void);

/**
 * Returns a URN string of the XML namespace name required for the
 * xsrs metadata.
 * This value is "urn:schemas-xsrs-org:metadata-1-0/x_srs/".
 * @return  "urn:schemas-xsrs-org:metadata-1-0/x_srs/" string.
 */
extern const du_uchar* dav_urn_xsrs_metadata1(void);
