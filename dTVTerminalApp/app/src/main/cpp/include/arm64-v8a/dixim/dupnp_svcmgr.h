...
extern du_bool dupnp_svcmgr_evtmgr_get_state_variable(dupnp_svcmgr* svcmgr, const du_uchar* service_id, const du_uchar* udn, const du_uchar* name, du_uchar_array* value_sent, du_uchar_array* value_unsent);
...
extern du_bool dupnp_svcmgr_evtmgr_set_sub_state_handler(dupnp_svcmgr* svcmgr, const du_uchar* service_id, const du_uchar* udn, dupnp_dvc_evtmgr_sub_state_handler handler, void* handler_arg);
