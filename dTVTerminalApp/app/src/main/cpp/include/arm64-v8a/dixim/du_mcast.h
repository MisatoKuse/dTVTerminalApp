 ...
 *  @param[in] sock  pointer to the du_socket data referencing a new socket.
 ...
 */
extern du_bool du_mcast_open(du_socket* sock, const du_ip* mcast_ip, const du_netif* netif);
...
/**
 *  Closes the socket.
 *  @param[in] sock  pointer to the du_socket data referencing the socket.
 */
extern void du_mcast_close(du_socket sock);
