...
typedef struct dupnp_dvc_evtmgr {
    ...
    dupnp_dvc_evtmgr_sub_state_handler sub_state_handler;
    void* sub_state_handler_arg;
} dupnp_dvc_evtmgr;
...
extern du_bool dupnp_dvc_evtmgr_get_state_variable(dupnp_dvc_evtmgr* evtmgr, const du_uchar* name, du_uchar_array* value_sent, du_uchar_array* value_unsent);
...
extern du_bool dupnp_dvc_evtmgr_set_sub_state_handler(dupnp_dvc_evtmgr* evtmgr, dupnp_dvc_evtmgr_sub_state_handler handler, void* handler_arg);
