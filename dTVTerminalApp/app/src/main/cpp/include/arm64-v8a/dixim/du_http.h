 ...
 *  @param[out] idx pointer to the variable to receive the index to the
 *    first occurrence of CR(Carriage Return)+LF(Line Feed) in the sb buffer.
 *  @return  true if the function succeeds.
 *           false if the function fails.
 */
extern du_bool du_http_find_line_socket(du_socket_input_buffer* sb, du_uint32* total, du_uint32* idx);
 ...
 *           false if the function fails.
 */
extern du_bool du_http_find_line_str(du_str_input_buffer* sb, du_uint32* total, du_uint32* idx);
