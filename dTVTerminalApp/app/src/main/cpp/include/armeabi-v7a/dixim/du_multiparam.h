 ...
 *  @param[in] x pointer to du_str_array structure.
 *  @param[in] idx index of the name-value pair (element) of x.
 *  @return pointer to the name data of the specified element in x,
 *   null if there is no index-element in x.
 */
extern const du_uchar* du_multiparam_get_name_by_index(const du_str_array* x, du_uint32 idx);
 ...
 *   null if there is no index-element in x.
 */
extern const du_uchar* du_multiparam_get_value_by_index(const du_str_array* x, du_uint32 idx);
 ...
 *  @param[in] idx index of the name-value pair (element) of x.
 */
extern void du_multiparam_remove_by_index(du_str_array* x, du_uint32 idx);
