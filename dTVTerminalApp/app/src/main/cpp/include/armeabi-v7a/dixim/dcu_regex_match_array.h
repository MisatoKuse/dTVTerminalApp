 ...
 */
#define dcu_regex_match_array_catn(to, from, len) du_array_catn((to), (const du_uint8*)(from), (len))
 ...
 */
#define dcu_regex_match_array_cato(to, object_ptr) du_array_cato((to), (const du_uint8*)(object_ptr))
