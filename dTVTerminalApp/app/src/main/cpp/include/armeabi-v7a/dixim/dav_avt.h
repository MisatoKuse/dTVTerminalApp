...
/**
  * Returns the action name of X_DLNA_GetBytePositionInfo.
  * @return the action name of X_DLNA_GetBytePositionInfo.
  */
extern const du_uchar* dav_avt_action_name_x_dlna_get_byte_position_info(void);

/**
 * Appends a SOAP request message of X_DLNA_GetBytePositionInfo action to a <em>xml</em> array.
 * @param[in] xml pointer to the destination du_uchar_array structure.
 * @param[in] v version number of this service.
 * @param[in] instance_id value of InstanceID argument.
 * @return  true if the function succeeds.
 *          false if the function fails.
 */
extern du_bool dav_avt_make_x_dlna_get_byte_position_info(du_uchar_array* xml, du_uint32 v, du_uint32 instance_id);

/**
 * Parses a SOAP request message of X_DLNA_GetBytePositionInfo action, stores each name and
 * value of argumentName element(s) of the envelope element
 * in <em>param_array</em>, and stores each argument value of the action to each parameter.
 * If a parse error occurred, it returns false.
 * Otherwise it returns true.
 ...
 * the <b>du_str_array_init</b> function.
 */
extern du_bool dav_avt_parse_x_dlna_get_byte_position_info(const du_uchar* xml, du_uint32 xml_len, du_str_array* param_array, du_uint32* instance_id);

/**
 * Appends a SOAP response message of X_DLNA_GetBytePositionInfo action to a <em>xml</em> array.
 * @param[in] xml pointer to the destination du_uchar_array structure.
 * @param[in] v version number of this service.
 * @param[in] track_size value of TrackSize argument.
 * @param[in] rel_byte value of RelByte argument.
 * @param[in] abs_byte value of AbsByte argument.
 * @return  true if the function succeeds.
 *          false if the function fails.
 */
extern du_bool dav_avt_make_x_dlna_get_byte_position_info_response(du_uchar_array* xml, du_uint32 v, const du_uchar* track_size, const du_uchar* rel_byte, const du_uchar* abs_byte);

/**
 * Parses a SOAP response message of X_DLNA_GetBytePositionInfo action, stores each name and
 * value of argumentName element(s) of the envelope element
 * in <em>param_array</em>, and stores each argument value of the action to each parameter.
 * If a parse error occurred, it returns false.
 * Otherwise it returns true.
 ...
 * @param[in] xml_len length of xml.
 * @param[out] param_array pointer to the destination du_str_array structure
 * @param[out] track_size pointer to the storage location for TrackSize argument value.
 * @param[out] rel_byte pointer to the storage location for RelByte argument value.
 * @param[out] abs_byte pointer to the storage location for AbsByte argument value.
 * @return  If a parse error occurred, it returns false. Otherwise it returns true.
 * @remark <em>param_appay</em> is a pointer to a <em>du_str_array</em> initialized by
 * the <b>du_str_array_init</b> function.
 */
extern du_bool dav_avt_parse_x_dlna_get_byte_position_info_response(const du_uchar* xml, du_uint32 xml_len, du_str_array* param_array, const du_uchar** track_size, const du_uchar** rel_byte, const du_uchar** abs_byte);
...
/**
 * the state variable name of 'X_DLNA_RelativeBytePosition'.
 * @return  "X_DLNA_RelativeBytePosition" string.
 */
extern const du_uchar* dav_avt_state_variable_name_x_dlna_relative_byte_position(void);

/**
 * the state variable name of 'X_DLNA_AbsoluteBytePosition'.
 * @return  "X_DLNA_AbsoluteBytePosition" string.
 */
extern const du_uchar* dav_avt_state_variable_name_x_dlna_absolute_byte_position(void);

/**
 * the state variable name of 'X_DLNA_CurrentTrackSize'.
 * @return  "X_DLNA_CurrentTrackSize" string.
 */
extern const du_uchar* dav_avt_state_variable_name_x_dlna_current_track_size(void);
