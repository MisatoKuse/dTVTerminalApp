 ...
 */
#define du_netif_array_catn(to, from, len) du_array_catn((to), (const du_uint8*)(from), (len))
 ...
 */
#define du_netif_array_cato(to, netif_ptr) du_array_cato((to), (const du_uint8*)(netif_ptr))
