 ...
 */
#define du_net_task_array_catn(to, from, len) du_array_catn((to), (const du_uint8*)(from), (len))
 ...
 */
#define du_net_task_array_cato(to, net_task_ptr) du_array_cato((to), (const du_uint8*)(net_task_ptr))
