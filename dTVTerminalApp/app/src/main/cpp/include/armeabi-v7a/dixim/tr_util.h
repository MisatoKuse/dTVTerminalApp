...
#define ENABLE_TR_UTIL
 ...
 #define truenc_secret_decrypt_l TRArcSecretDecryptL
    extern void truenc__ddtcp_private_data_io__restore_key__mutex_lock(void);
    extern void truenc__ddtcp_constant_data_io__restore_key__mutex_lock(void);
    extern void truenc__ddtcp_ake_exhchange_key__scramble_mv_exch_key__mutex_lock(void);
    extern void truenc__ddtcp_pcp__create_content_key__mutex_lock(void);
    extern void truenc__ddtcp_util_scrambler__ddtcp_util_scrambler_scramble__mutex_lock(void);
    extern void truenc__ddtcp_util_scrambler__ddtcp_util_descrambler_scramble__mutex_lock(void);
    extern void truenc__ddtcp_private_data_io__restore_device_specific_rsr_hash_key__mutex_lock(void);
    extern void truenc__secure_io_local_key__secure_io_local_key__mutex_lock(void);
    extern void truenc__ddtcp_private_data_io__restore_key__mutex_unlock(void);
    extern void truenc__ddtcp_constant_data_io__restore_key__mutex_unlock(void);
    extern void truenc__ddtcp_ake_exhchange_key__scramble_mv_exch_key__mutex_unlock(void);
    extern void truenc__ddtcp_pcp__create_content_key__mutex_unlock(void);
    extern void truenc__ddtcp_util_scrambler__ddtcp_util_scrambler_scramble__mutex_unlock(void);
    extern void truenc__ddtcp_util_scrambler__ddtcp_util_descrambler_scramble__mutex_unlock(void);
    extern void truenc__ddtcp_private_data_io__restore_device_specific_rsr_hash_key__mutex_unlock(void);
    extern void truenc__secure_io_local_key__secure_io_local_key__mutex_unlock(void);
#else
