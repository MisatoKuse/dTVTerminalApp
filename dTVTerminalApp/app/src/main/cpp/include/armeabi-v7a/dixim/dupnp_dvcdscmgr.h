...
typedef du_bool (*dupnp_dvcdscmgr_device_desc_visitor)(dupnp_dvcdsc* dvcdsc, dupnp_dvcdsc_device* device_desc, void* arg);
...
extern void dupnp_dvcdscmgr_visit_device_desc(dupnp_dvcdscmgr* dvcdscmgr, dupnp_dvcdscmgr_device_desc_visitor visitor, void* arg);
