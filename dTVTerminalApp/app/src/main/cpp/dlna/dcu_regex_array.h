 ...
 */
#define dcu_regex_array_catn(to, from, len) du_array_catn((to), (du_uint8*)(from), (len))
 ...
 */
#define dcu_regex_array_cato(to, object_ptr) du_array_cato((to), (du_uint8*)(object_ptr))
