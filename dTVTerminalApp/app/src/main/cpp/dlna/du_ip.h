 ...
 *  @param[out] ip  pointer to the du_ip data structure.
 *  @param[in] addr_str specifies the IP address string.
 ...
 *  @param[out] family pointer to the variable to receive the address family value of the IP address. * @param[out] addr_str du_uchar array variable to receive the IP address string.
