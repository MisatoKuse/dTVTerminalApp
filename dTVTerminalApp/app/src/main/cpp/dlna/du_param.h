 ...
 *  Gets name by index.
 *  @param[in] param_array pointer to du_str_array structure.
 *  @param[in] index index of the name-value pair (element) of param_array.
 *  @return pointer to the name data of the specified element in param_array,
 *   null if there is no index-element in param_array.
 */
extern const du_uchar* du_param_get_name(const du_str_array* param_array, du_uint32 index);
 ...
 *   null if there is no index-element in param_array.
 */
extern const du_uchar* du_param_get_value(const du_str_array* param_array, du_uint32 index);
 ...
 *  @param[in] index index of the name-value pair (element) of param_array.
 */
extern void du_param_remove_by_index(du_str_array* param_array, du_uint32 index);
